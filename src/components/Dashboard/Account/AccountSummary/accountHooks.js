...
export const useAccountData = () => {
  ...
  const hasFetchedAccount = useSelector(state => state.account?.hasFetchedAccount || false);
  const accountLoading = useSelector(state => state.account?.accountLoading || false);
  ...
  return {
    ...
    shouldFetch: !hasFetchedAccount && customerId && authtoken && !accountLoading,
...
export const useAccountSelection = () => {
  const dispatch = useDispatch();
  const selectedAccount = useSelector(state => state.account?.selectedAccount || null);
  const selectedCurrency = useSelector(state => state.account?.selectedCurrency || "all");
  const accounts = useSelector(state => state.account?.accounts || []);
...
export const useAccountBalance = () => {
  ...
  const authtoken = useSelector(selectAuthToken);
  const selectedAccount = useSelector(state => state.account?.selectedAccount || null);
  const balanceLoading = useSelector(state => state.account?.balanceLoading || false);
