...
Bank Address: ${
      accountData.priority_bank_address || accountData.bank_address || "N/A"
    }
    `.trim();
              ...
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex space-x-3">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm font-medium rounded-lg hover:opacity-90 transition-all flex items-center space-x-2"
                  >
                    <FiCopy size={14} />
