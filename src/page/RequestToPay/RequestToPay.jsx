...
const RequestToPay = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const resolvedCustomerId = localStorage.getItem("authcustomer_id") || "";
            const submissionData = new FormData();
            submissionData.append("customer_id", resolvedCustomerId);
                        ...
                        <form onSubmit={handleSubmit} className="p-4 sm:p-8 space-y-4 sm:space-y-6">
                            ...
                            <div id="field-clientType">
                                ...
                                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                                    <label
                                        className={`flex items-center justify-center gap-2 p-3 sm:p-3.5 rounded-xl border cursor-pointer font-medium text-xs sm:text-sm transition-all ${formData.clientType === "3"
                                    ...
                                    <label
                                        className={`flex items-center justify-center gap-2 p-3 sm:p-3.5 rounded-xl border cursor-pointer font-medium text-xs sm:text-sm transition-all ${formData.clientType === "23"
                                            ? "border-blue-500 bg-blue-50/60 text-blue-700 shadow-sm"
                                            : "border-gray-200 hover:bg-gray-50 text-gray-600"
                                            } ${errors.clientType ? "border-red-500" : ""}`}
                                    >
                            ...
                            {formData.clientType === "23" && (
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl border text-sm focus:outline-none transition ${errors.companyName
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            placeholder="Jane"
                                            className={`w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl border text-sm focus:outline-none transition ${errors.firstName
                                                ? "border-red-500 focus:ring-2 focus:ring-red-200"
                                                : "border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                                }`}
                                        />
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            placeholder="Doe"
                                            className={`w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl border text-sm focus:outline-none transition ${errors.lastName
                                                ? "border-red-500 focus:ring-2 focus:ring-red-200"
                                                : "border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                                }`}
                                        />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl border text-sm focus:outline-none transition ${errors.email
                                            ? "border-red-500 focus:ring-2 focus:ring-red-200"
                                            : "border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                            }`}
                                    />
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <div className="relative w-36 sm:w-40 flex-shrink-0" ref={phoneRef}>
                                            <div
                                                className={`h-full px-2.5 py-1 sm:py-1.5 rounded-xl border bg-white flex items-center gap-1.5 transition ${errors.phoneCountryCode
                                        ...
                                        <input
                                            ...
                                            className={`flex-1 min-w-0 px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl border text-sm focus:outline-none transition ${errors.mobileNumber
                                                ? "border-red-500 focus:ring-2 focus:ring-red-200"
                                                : "border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                                }`}
                                        />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                ...
                                <div className="relative" ref={countryRef}>
                                    ...
                                    <div
                                        className={`w-full px-3.5 py-1.5 sm:py-2 rounded-xl border bg-white flex items-center gap-2 text-sm transition ${errors.country
                                            ? "border-red-500 ring-1 ring-red-200"
                                            : "border-gray-200 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-100"
                                            }`}
                                    >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl border text-sm focus:outline-none transition ${errors.state
                                            ? "border-red-500 focus:ring-2 focus:ring-red-200"
                                            : "border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                            }`}
                                    />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                                <div className="relative" ref={currencyRef}>
                                    ...
                                    <button
                                        ...
                                        className={`w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl border bg-white flex items-center justify-between text-sm transition ${errors.currency
                                            ? "border-red-500"
                                            : "border-gray-200 hover:bg-gray-50"
                                            }`}
                                    >
                                        <span
                                            className={`truncate ${formData.currency
                                        ...
                                        <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-xl shadow-lg z-50 p-1.5">
                                            {CURRENCY_CONFIG.map((curr) => (
                                                <button
                                                    ...
                                                    className={`w-full flex items-center justify-between px-3 py-2 text-xs rounded-lg transition ${formData.currency === curr.code
                                ...
                                <div>
                                    ...
                                    <div className="relative flex items-center">
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            placeholder="0.00"
                                            className={`w-full pl-9 pr-3.5 py-2.5 sm:pr-4 sm:py-3 rounded-xl border text-sm focus:outline-none transition ${errors.amount
                                                ? "border-red-500 focus:ring-2 focus:ring-red-200"
                                                : "border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                                }`}
                                        />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className={`w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl border text-sm focus:outline-none transition ${errors.dueDate
                                            ? "border-red-500 focus:ring-2 focus:ring-red-200"
                                            : "border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                            }`}
                                    />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                ...
                                <div className="relative" ref={reasonRef}>
                                    ...
                                    <button
                                        ...
                                        className={`w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl border bg-white flex items-center justify-between text-sm transition ${errors.reason
                                            ? "border-red-500"
                                            : "border-gray-200 hover:bg-gray-50"
                                            }`}
                                    >
                                        <div className="flex items-center gap-2 truncate">
                                            ...
                                            <span
                                                className={`truncate ${formData.reason ? "text-gray-800" : "text-gray-400"
                                                    }`}
                                            >
                            ...
                            <div id="field-statementFile">
                                ...
                                {!formData.statementFile ? (
                                    <label
                                        className={`flex flex-col items-center justify-center p-5 sm:p-6 border-2 border-dashed rounded-xl sm:rounded-2xl cursor-pointer hover:bg-gray-50/60 transition ${errors.statementFile
