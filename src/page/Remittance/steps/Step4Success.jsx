...
const Step4Success = ({
  ...
  // Handle stay on receipt page
  const handleStayOnReceipt = () => {
    setShowRedirectModal(false);
    // User stays on the page, no redirect
  };
  ...
  return (
    <>
              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all flex items-center justify-center gap-3 font-medium"
                  >
                  ...
                  <button
                    onClick={handleStayOnReceipt}
                    className="w-full py-3 border-2 border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition-all flex items-center justify-center gap-3 font-medium"
                  >
                    <FaReceipt className="w-5 h-5" />
                    Stay on Receipt Page
                  </button>

                  <button
                    onClick={handleNewTransfer}
                    className="w-full py-3 border-2 border-green-300 text-green-700 rounded-xl hover:bg-green-50 transition-all flex items-center justify-center gap-3 font-medium"
                  >
      ...
      {/* Main Success Content - Only show if modal is closed */}
      {!showRedirectModal && (
        <motion.div
